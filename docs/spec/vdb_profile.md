...
bijux-vex is **not** a vector database. It provides execution contracts, not storage guarantees. No `ExecutionProfile.VDB` exists for v0.1.0; any persistence semantics are limited to the execution ledger.
