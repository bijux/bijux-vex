...
quality:
	...
	@rm -rf site  # ensure mkdocs artifacts do not pollute REUSE checks
	@$(MAKE) hygiene
...
##@ Quality
quality: ## Run Vulture, Deptry, REUSE, Interrogate; save logs to artifacts/quality/
