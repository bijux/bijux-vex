...
CORE_BOUNDARIES       := $(abspath src/bijux_vex/core) $(abspath src/bijux_vex/contracts) $(abspath src/bijux_vex/domain)
...
coverage-core:
	@echo "→ Coverage (core/execution_contract/domain, fail-under=90%)"
